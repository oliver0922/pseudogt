...
def main(args):
    ...
    if args.vis:
        ...
        with open(f'results/insatnce_bounding_box_list.pkl', 'wb') as f:
            pickle.dump(instance_bounding_box_list, f)
        with open(f'results/t_bbox_list.pkl', 'wb') as f:
            pickle.dump(t_bbox_list, f)
        with open(f'results/sparse_bbox_list.pkl', 'wb') as f:
            pickle.dump(sparse_bbox_list, f)
        with open(f'results/unique_instance_id_list.pkl', 'wb') as f:
            pickle.dump(unique_instance_id_list, f)
        with open(f'results/registration_data_list.pkl', 'wb') as f:
            pickle.dump(registration_data_list, f)
        with open(f'results/sparse_bbox_data_list.pkl', 'wb') as f:
            pickle.dump(sparse_bbox_data_list, f)
        with open(f'results/instance_frame_pcd_list.pkl', 'wb') as f:
            pickle.dump(instance_frame_pcd_list, f)
        with open(f'results/args.pkl', 'wb') as f:
            pickle.dump(args, f)
